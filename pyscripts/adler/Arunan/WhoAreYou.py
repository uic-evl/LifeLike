...
class PythonActivity( LLActivityBase ):
	...
	def initialize( self ):
		...
		self.whoareyouspeech.add("My name is Mike. I am a LifeLike avatar. designed to interact with people.")
		self.whoareyouspeech.add("I'm Mike.")
		self.whoareyouspeech.add("I'm Michael Lewis.")
