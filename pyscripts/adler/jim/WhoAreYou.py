...
class PythonActivity( LLActivityBase ):
	...
	def initialize( self ):
		...
		self.registerTransition("who are you:what are you:what is your name:how are you:how are you doing:are you real:where are you")
		...
		self.whoareyouspeech.add("My name is Jim Lovell. I am a LifeLike avatar. designed to interact with people.")
		self.whoareyouspeech.add("I'm Jim.")
		self.whoareyouspeech.add("I'm Jim Lovell.")
